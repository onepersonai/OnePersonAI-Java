...
public class Config {
    ...
    public static final String ENV_DEBUG = "OPAI_DEBUG";

    public static final String ENV_HTTP_HOST = "OPAI_HTTP_HOST";

    public static final String ENV_HTTP_PORT = "OPAI_HTTP_PORT";

    public static final String ENV_MONGO_DB_NAME = "OPAI_MONGO_DB_NAME";

    public static final String ENV_MONGO_TABLE_PREFIX = "OPAI_MONGO_TABLE_PREFIX";

    public static final String ENV_MONGO_CONNECTION_STRING = "OPAI_MONGO_CONNECTION_STRING";

    public static final String ENV_MAIL_USER = "OPAI_MAIL_USER";

    public static final String ENV_MAIL_PASSWORD = "OPAI_MAIL_PASSWORD";

    public static final String ENV_MAIL_HOST = "OPAI_MAIL_HOST";

    public static final String ENV_MAIL_PORT = "OPAI_MAIL_PORT";

    public static final String ENV_MAIL_SSL = "OPAI_MAIL_SSL";

    public static final String ENV_JWT_PASSWORD = "OPAI_JWT_PASSWORD";

    public static final String ENV_IMAGE_FOLDER_USER = "OPAI_IMAGE_FOLDER_USER";

    public static final String ENV_IMAGE_FOLDER_APPS = "OPAI_IMAGE_FOLDER_APPS";

    public static final String ENV_AUTH_SERVICE = "OPAI_AUTH_SERVICE";

    public static final String ENV_KEY_CLOAK_REALM = "OPAI_KEYCLOAK_REALM";

    public static final String ENV_KEY_CLOAK_SERVER = "OPAI_KEYCLOAK_SERVER";

    public static final String ENV_KEY_CLOAK_CLAIM_ROLE = "OPAI_KEY_CLOAK_CLAIM_ROLE";

    public static final String ENV_KEY_CLOAK_ISSUER = "OPAI_KEY_CLOAK_ISSUER";

    public static final String ENV_KEY_CLOAK_CLAIM_ID = "OPAI_KEY_CLOAK_CLAIM_ID";

    public static final String ENV_KEY_CLOAK_CLAIM_EMAIL = "OPAI_KEY_CLOAK_CLAIM_EMAIL";

    public static final String ENV_KEY_CLOAK_CLAIM_NAME = "OPAI_KEY_CLOAK_CLAIM_NAME";

    public static final String ENV_KEY_CLOAK_CLAIM_LASTNAME = "OPAI_KEY_CLOAK_CLAIM_LASTNAME";

    public static final String ENV_USER_ALLOW_SIGNUP = "OPAI_USER_ALLOW_SIGNUP";

    public static final String ENV_USER_ALLOWED_DOMAINS = "OPAI_USER_ALLOWED_DOMAINS";
    ...
    public static JsonObject setDefaults(JsonObject config) {
        ...
        if (!result.containsKey(HTTP_HOST)) {
            result.put(HTTP_HOST, "https://onepersonai.cn");
        }
        ...
        result.put("image.size", 50000000);
        return result;
    }
